...
![Version: 0.2.2](https://img.shields.io/badge/Version-0.2.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.2.3](https://img.shields.io/badge/AppVersion-1.2.3-informational?style=flat-square)
...
|------------|------|---------|
| https://grafana.github.io/helm-charts | grafana-agent | 0.24.0 |
| https://grafana.github.io/helm-charts | grafana-agent-logs(grafana-agent) | 0.24.0 |
| https://opencost.github.io/opencost-helm-chart | opencost | 1.19.3 |
| https://prometheus-community.github.io/helm-charts | kube-state-metrics | 5.13.0 |
| https://prometheus-community.github.io/helm-charts | prometheus-node-exporter | 4.23.0 |
...
| logs.cluster_events.namespaces | list | `[]` | List of namespaces to watch for events (empty means all namespaces) |
...
| logs.pod_logs.namespaces | list | `[]` | Only capture logs from pods in these namespaces (empty means all namespaces) |
