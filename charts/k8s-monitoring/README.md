...
![Version: 0.11.2](https://img.shields.io/badge/Version-0.11.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.0.2](https://img.shields.io/badge/AppVersion-2.0.2-informational?style=flat-square)
...
|------------|------|---------|
| https://grafana.github.io/helm-charts | grafana-agent | 0.36.0 |
| https://grafana.github.io/helm-charts | grafana-agent-events(grafana-agent) | 0.36.0 |
| https://grafana.github.io/helm-charts | grafana-agent-logs(grafana-agent) | 0.36.0 |
