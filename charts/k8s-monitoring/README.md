...
* node_cpu_seconds_total #from windows_cpu_time_total
* node_filesystem_size_bytes #from windows_logical_disk_size_bytes
* node_filesystem_avail_bytes #from windows_logical_disk_free_bytes
* container_memory_.* #from windows_container_memory_* - partially bugged (pod label missing)
* container_cpu_usage_seconds_total #from windows_container_cpu_usage_seconds_total - partially bugged (pod label missing)
* kubelet_node_name #from windows_cs_hostname
* kubelet_running_containers #from windows_container_count, might map to kubelet_running_pod_count or kubelet_running_pods instead
* node_memory_Mem.* #from windows_memory_available_bytes, windows_os_physical_memory_free_bytes and windows_cs_physical_memory_bytes
* node_memory.* #from node_memory_.*
