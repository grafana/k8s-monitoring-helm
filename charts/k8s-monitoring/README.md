...
| opencost.opencost.prometheus.secret_name | string | "prometheus-k8s-monitoring" | Name of the secret when using a custom secret |
| opencost.opencost.prometheus.username_key | string | "" | The key for the username property in the secret |
| opencost.opencost.prometheus.password_key | string | "" | The key for the password property in the secret |
