...
| processors.transform.logs.logFrom | list | `[]` | Log transforms, All values are treated as raw strings and not quoted. |
...
| processors.transform.logs.resourceFrom | list | `[]` | Log resource transforms, All values are treated as raw strings and not quoted. |
| processors.transform.metrics.datapoint | list | `[]` | Metric datapoint transforms |
| processors.transform.metrics.datapointFrom | list | `[]` | Metric datapoint transforms, All values are treated as raw strings and not quoted. |
...
| processors.transform.metrics.metricFrom | list | `[]` | Metric transforms, All values are treated as raw strings and not quoted. |
| processors.transform.metrics.resource | list | `[]` | Metric resource transforms |
| processors.transform.metrics.resourceFrom | list | `[]` | Metric resource transforms, All values are treated as raw strings and not quoted. |
| processors.transform.traces.resource | list | `[]` | Trace resource transforms |
| processors.transform.traces.resourceFrom | list | `[]` | Trace resource transforms, All values are treated as raw strings and not quoted. |
| processors.transform.traces.span | list | `[]` | Trace span transforms |
| processors.transform.traces.spanFrom | list | `[]` | Trace span transforms, All values are treated as raw strings and not quoted. |
| processors.transform.traces.spaneventFrom | list | `[]` | Trace spanevent transforms, All values are treated as raw strings and not quoted. |
