...
| processors.serviceGraphMetrics.dimensions | list | `["cloud.availability_zone","cloud.region","deployment.environment","deployment.environment.name","k8s.cluster.name","k8s.namespace.name","service.namespace","service.version"]` | A list of dimensions to add with the default dimensions. |
