...
|-----|------|---------|-------------|
| alloy | object | `{"resources":{"limits":{"cpu":"4000m","memory":"16Gi"},"requests":{"cpu":"1000m","memory":"8Gi"}}}` | Sets resource requests and limits sized for very large clusters (approximately 1000+ nodes or heavy telemetry workloads). See [Alloy resource estimation guidelines](https://grafana.com/docs/alloy/latest/introduction/estimate-resource-usage/) for tuning. |
