...
This example shows how to generate [service graph metrics](https://grafana.com/docs/tempo/latest/metrics-generator/service_graphs/)
from traces using the k8s-monitoring Helm chart.
