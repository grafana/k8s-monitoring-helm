...
This example shows how to enable the annotation-based autodiscovery feature, which adds scrape targets based on
Kubernetes annotations. With this feature enabled, any Kubernetes Pods or Services with the `k8s.grafana.com/scrape`
annotation set to `true` will be automatically discovered and scraped by the collector. There are several other
annotations that can be used to customize the behavior of the scrape configuration, such as:
...
For more information, see the [Annotation Autodiscovery feature documentation](https://github.com/grafana/k8s-monitoring-helm/tree/main/charts/k8s-monitoring/charts/feature-annotation-autodiscovery).
