...
The following is the list of images potentially used in the 3.1.3 version of the k8s-monitoring Helm chart:

| Image Name | Repository | Feature |
| ---------- | ---------- | ------- |
| Alloy | docker.io/grafana/alloy:v1.9.2 | Always used. The telemetry data collector. Enabled with `alloy-____.enabled=true`. Deployed via the Alloy Operator. |
| Alloy Operator | ghcr.io/grafana/alloy-operator:1.1.2 | Always used. Deploys and manages Grafana Alloy collector instances. |
