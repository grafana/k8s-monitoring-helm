...
The following is the list of images potentially used in the 2.0.26 version of the k8s-monitoring Helm chart:

| Image Name | Repository | Feature |
| ---------- | ---------- | ------- |
| Alloy | docker.io/grafana/alloy:v1.8.2 | Always used. The telemetry data collector. |
...
| Kepler | quay.io/sustainable_computing_io/kepler:release-0.7.12 | Gathers energy metrics for Kubernetes objects. Enabled with `clusterMetrics.kepler.enabled=true`. |
