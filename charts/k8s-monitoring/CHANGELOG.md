...
*   Add `processors.serviceGraphMetrics.loadBalancerResolver` to OTLP destinations, choosing how the load balancing exporter routes traces to the service graph Alloy instances. (@petewall)
