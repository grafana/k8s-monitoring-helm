...
*   Remove the unreachable `k8s.replicaset.name` and `k8s.container.name` rules from the Pod Logs via OpenTelemetry `service.name` fallback (`k8s.pod.name` is always set earlier in the chain) (#2651) (@jmichalek132)
