...
| labelSelectors | list | `[]` | Discover Alloy instances based on label selectors. |
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| jobName | string | `"integrations/alloy"` | The value of the job label for scraped metrics and logs |
