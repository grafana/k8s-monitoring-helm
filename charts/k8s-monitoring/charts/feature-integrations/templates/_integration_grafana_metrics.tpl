...
{{- end }}
  scrape_interval = {{ include "enforce_min_scrape_interval" (dict "interval" (.metrics.scrapeInterval | default .scrapeInterval | default $.Values.global.scrapeInterval) "min" $.Values.global.minScrapeInterval) | quote }}
