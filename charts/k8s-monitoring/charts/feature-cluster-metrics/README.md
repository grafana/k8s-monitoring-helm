...
| https://prometheus-community.github.io/helm-charts | node-exporter(prometheus-node-exporter) | 4.44.0 |
| https://prometheus-community.github.io/helm-charts | windows-exporter(prometheus-windows-exporter) | 0.9.0 |
...
| apiServer.metricsTuning.dropRequestDurationBuckets | list | `[0.15,0.25,0.3,0.35,0.4,0.45,0.6,0.7,0.8,0.9,1.25,1.5,1.75,2.5,3,3.5,4.5,6,7,8,9,15,25,30,50]` | Drop certain buckets from the `apiserver_request_duration_seconds_bucket` metric. To keep all buckets, set this to an empty list. |
