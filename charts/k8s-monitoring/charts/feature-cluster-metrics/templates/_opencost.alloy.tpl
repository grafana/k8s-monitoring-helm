...
prometheus.scrape "opencost" {
  ...
  honor_labels = true
  scrape_interval = {{ include "enforce_min_scrape_interval" (dict "interval" (.Values.opencost.scrapeInterval | default .Values.global.scrapeInterval) "min" .Values.global.minScrapeInterval) | quote }}
