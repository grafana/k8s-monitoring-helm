...
prometheus.scrape "node_exporter" {
  ...
  scrape_interval = {{ include "enforce_min_scrape_interval" (dict "interval" (.Values.linuxHosts.scrapeInterval | default .Values.global.scrapeInterval) "min" .Values.global.minScrapeInterval) | quote }}
