...
`tpu-device-plugin` pods and scrapes their TPU metrics — duty cycle, TensorCore utilization, memory usage and
bandwidth, and so on — forwarding them to the metrics destination.
