Describe 'Embedded Secrets Check'
  Describe 'Using secret.embed = true'
    It 'does not create any Kubernetes Secrets'
      When call wget --spider --server-response https://github.com/grafana/alloy-operator/releases/download/v${ALLOY_OPERATOR_VERSION}/collectors.grafana.com_alloy.yaml
