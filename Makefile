...
.PHONY: lint-misspell
ALL_FILES_FOR_SPELLCHECK = $(shell find . -type f -not \( -path "./node_modules/*" -o -path "./data-alloy/*" -o -path "./.git/*" -o -name output.yaml -o -name "*.snap" -o -name "*.alloy" -o -name .textlintrc -o -name .envrc -o -name .gitkeep -o -name .gitignore -o -name "*.gotmpl" \) )
